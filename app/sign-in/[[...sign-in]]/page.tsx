    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      <div className="w-full max-w-md">
        <div className="mb-8 text-center">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Welcome to Sahayak AI</h1>
          <p className="mt-2 text-gray-600 dark:text-gray-400">Your Mental Health Buddy</p>
        </div>
        <SignIn
          appearance={{
            elements: {
